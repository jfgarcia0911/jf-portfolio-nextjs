...
export default function Navbar() {
	...
	return (
		<header
			className={`fixed top-0 left-0 w-full z-50 text-white' data-aos='fade-up' data-aos-delay='300  ${
		...
		>
			...
			{/* Mobile Screen */}
			<div
				className={`${isOpen ? "block" : "hidden"} md:hidden bg-blue-800/80 backdrop-blur-md absolute top-0 left-0 w-full h-screen flex flex-col items-center  space-y-8 pt-16 z-100`}
			>
				{/* Close Button */}
				<button
